...
def train(args, train_embeddings, train_y_true, h_x, n_concepts, writer, device,
          cluster_centers=None, lambda_shap=0.0):
    '''
...
if __name__ == "__main__":
    ...
    parser.add_argument('--shap_n_clusters', type=int, default=8,
                        help="clusters for shap-based cluster")
    parser.add_argument('--lambda_shap', type=float, default=0.0,
